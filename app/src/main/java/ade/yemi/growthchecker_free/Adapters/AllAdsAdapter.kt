                ...
                if (adslist.VideoLink!!.CheckEmpty() != true){
                    ...
                    vidlink.setOnClickListener {
                        ...
                        try {
                            ...
                            Toast.makeText(view.context, "2 Tokens Added", Toast.LENGTH_SHORT).show()
                        }catch (e : Exception){
                            Toast.makeText(view.context, "Could not open video. No Token Added", Toast.LENGTH_SHORT).show()
                        }
                         }
                }else{
                ...
                if (adslist.Link != ""){
                    adbutton.setOnClickListener {
                        ...
                        try {
                            ...
                            Toast.makeText(view.context, "Could not open link. No Tokens Added", Toast.LENGTH_SHORT).show()
                        }
                        }
